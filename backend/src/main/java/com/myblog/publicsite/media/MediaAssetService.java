...
public class MediaAssetService {
    ...
    public MediaAssetService(ObjectProvider<JdbcTemplate> jdbcTemplate, MediaStorage storage) {
    ...
    public MediaAsset upload(String fileName, byte[] content, String altText) {
        ...
        asset.checksumSha256 = com.myblog.publicsite.admin.TokenUtil.sha256Hex(content);
