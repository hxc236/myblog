...
import com.myblog.publicsite.admin.InvalidExchangeCodeException;
...
public class AdminAuthController {
    ...
    public ResponseEntity<?> me(Authentication authentication) {
        ...
        String login = ((com.myblog.publicsite.admin.AdminPrincipal) authentication.getPrincipal()).getLogin();
